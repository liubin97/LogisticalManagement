						...
						<div class="widget am-cf">
							...
							<div class="widget-body  am-fr">
								...
								<form class="am-form tpl-form-border-form tpl-form-border-br"
									name="" action="invoiceServlet?action=use" id="use" method="post">

									<div class="am-form-group">
										<label class="am-u-sm-3 am-form-label">发票号码</label>
										<div class="am-u-sm-9">
											<input type="text" name="invoiceNumber" style="width: 200px;"
												class="am-form-field" id="invoiceNumber" onblur="validateInvoice()" placeholder="全数字最多8位，首数字不为0">
									...
									<div class="am-form-group">
										<label class="am-u-sm-3 am-form-label">领用分站</label>
										<div class="am-u-sm-9">
											<select data-am-selected name="subName" class="substation">
									...
									<div class="am-form-group">
										<div class="am-u-sm-9 am-u-sm-push-3">
											<a class="button" href="###"><button type="button" onclick="test()"
													class="am-btn am-btn-success">领用</button></a>
										</div>
									</div>
