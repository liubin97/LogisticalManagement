        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display:block">
                    ...
                    <li class="sidebar-nav-link" >
                        <a href="Central%20return%20out.jsp" class="sub-active">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf"><h1>中心库房退货出库</h1></div>
                        </div>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-6 am-u-lg-centered">
                                        <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                            <input type="text" class="am-form-field tpl-form-no-bg"  name="search" id="search" required placeholder="请输入退货单号查询" onkeyup="value=value.replace(/[^\d]/g,'') " ng-pattern="/[^a-zA-Z]/">
