...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="assets/js1/purchase.js"></script>
    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-content-wrapper">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf"><h1>预警进货安排</h1></div>


                            </div>
                            <div class="widget-body  am-fr">
								<form action="purchaseReturnServlet?action=searchwarn" method="post" class="am-form tpl-form-border-form tpl-form-border-br" >	
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-table-list-field am-icon-search"  type="submit"></button>
               ...
               <c:forEach items="${resultList}" var="warn" >
				<tr>
					<td>${warn.onetitle_name}</td>
					<td>${warn.twotitle_name}</td>
					<td>${warn.prod_id}</td>
					<td>${warn.prod_name}</td>		
					<td>${warn.can_distribute}</td>	
					<td>${warn.warn_num}</td>		
					<td>${warn.outofstock}</td>	
					<td>${warn.measurement}</td>	
					<td>
				  <input type="number" id="pnum${warn.prod_id}" name="pnum"  placeholder="数量" style="width=50px" required>
                     <input type="text" id="do_date${warn.prod_id}" name="do_date" placeholder="时间" data-am-datepicker="" readonly="">
                                <i class="am-icon-trash" onclick="show(${warn.prod_id})">进货</i> 
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    ...
                                    <div class="am-fr">
                                        ...
                                        <c:if test="${pageNum-1!=0}">
											<li><a href="purchaseReturnServlet?action=searchwarn&pageno=${pageNum-1}">«</a></li>
										</c:if>
										...
										<c:if test="${p!=pageNum}">
											<li><a href="purchaseReturnServlet?action=searchwarn&pageno=${p}"  >${p}</a></li>      
										</c:if>
