...
<script src="assets/js/settlement-with-sub-station-unsettled.js"></script>
						...
						<div class="widget am-cf">
							...
							<div class="widget-body  am-fr">
								<form class="am-form am-form-inline"
									action="substationServlet?action=unsettled" method="post"
									role="form" >
							...
							<form action="substationServlet?action=information" method="post" id="confirm">
								<div class="row">
												...
												<c:forEach items="${resultList}" var="infor">
														<tr class="gradeX">
															<td><input type="checkbox" class="subchk"
																value="${infor.taskId }" name="chk">
																<input type="hidden"
																value="${infor.subName }" name="subName">
																<input type="hidden"
																value="${infor.type }" name="type">
																<input type="hidden"
																...
																<input type="hidden"
																value="${infor.amount }" name="amount">
																<input type="hidden"
									...
									<li><a class="button" href="substationServlet?action=moreInfor&pageSize=${pageSize+5}&option=unsettled" >获取更多</a></li>
									<li><a class="button" href="substationServlet?action=moreInfor&pageSize=${pagecount*pageSize}&option=unsettled" >显示全部</a></li>
                                        ...
                                        <c:if test="${pageNum-1!=0}">
											<li><a href="substationServlet?action=unsettled&pageNum=${pageNum-1}">«</a></li>
										</c:if>
										...
										<c:if test="${p!=pageNum}">
											<li><a href="substationServlet?action=unsettled&pageNum=${p}"  >${p}</a></li>      
										</c:if>
										</c:forEach>
