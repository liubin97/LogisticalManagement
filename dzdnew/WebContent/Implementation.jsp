    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-content-wrapper">
            <div class="row-content am-cf">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf"><h1>分站任务执行情况</h1></div>


                            </div>
                            <div class="widget-body  am-fr">

									<form action="searchInfoServlet?action=implement" method="post" class="am-form tpl-form-border-form tpl-form-border-br" data-am-validator>	
										<div class="am-u-lg-2">
               ...
               <c:forEach items="${resultList}" var="im" >
				<tr>
					<td>${im.wh_id}</td>
					<td>${im.wh_name}</td>
					<td>${im.cc}</td>
