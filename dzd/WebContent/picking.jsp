        ...
        <ul class="sidebar-nav">
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display:block">
                    ...
                    <li class="sidebar-nav-link">
                        <a href="picking.jsp"  class="sub-active">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf"><h1>领货</h1></div>
                        </div>
                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <form class="am-form tpl-form-line-form" action="subWarehouseServlet?action=submitTaskOut" onsubmit="return submitConfirm()" method="post" data-am-validator>
