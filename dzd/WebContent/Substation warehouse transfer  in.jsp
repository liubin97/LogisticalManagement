                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-6 am-u-lg-centered">
                                        <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                            <input type="text" class="am-form-field tpl-form-no-bg" placeholder="请输入验货单号查询入库单" >
                            ...
                            <form class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" required="required" placeholder="若商品数量与实际不一致，填写此信息">
                                    </div>
                                </div>
...
<!--<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt">-->
    <!--<div class="am-modal-dialog">-->
        <!--<div class="am-modal-hd">分站调拨入库</div>-->
        <!--<div class="am-modal-bd">-->

            <!--<p><input type="text" class="am-modal-prompt-input " placeholder="请选择入库日期" data-am-datepicker="" ></p>-->
            <!--<p><input  class="am-modal-prompt-input"  placeholder="若入库数量与实际数量不符，输入此备注信息"></p>-->
        <!--</div>-->
        <!--<div class="am-modal-footer">-->
            <!--<span class="am-modal-btn" data-am-modal-cancel>取消</span>-->
            <!--<span class="am-modal-btn" data-am-modal-confirm>入库</span>-->
        <!--</div>-->
    <!--</div>-->
<!--</div>-->
<!--<script>-->
