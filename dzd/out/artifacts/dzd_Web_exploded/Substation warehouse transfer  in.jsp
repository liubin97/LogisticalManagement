        ...
        <ul class="sidebar-nav">
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub" style="display:block">
                    <li class="sidebar-nav-link">
                        <a href="Substation%20warehouse%20transfer%20%20in.jsp"   class="sub-active">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf"><h1>分站库房调拨入库</h1></div>
                        </div>
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-6 am-u-lg-centered">
                                        <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                            ...
                                            <button class="am-btn  am-btn-default am-btn-primary tpl-table-list-field am-icon-search" type="button" onclick="doSearchInByTaskId()"></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form class="am-form tpl-form-line-form" action="subWarehouseServlet?action=submitTaskIn" onsubmit="return submitConfirm()" method="post" data-am-validator>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="indate" name="indate" class="am-form-field tpl-form-no-bg" placeholder="请选择入库日期" required data-am-datepicker readonly >
                                    </div>
                                </div>
                                <div class="am-form-group">
